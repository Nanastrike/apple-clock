...
public interface WorkLogsRepository  {
    ...
    List<WorkLogs> findByDateAndWorkType(LocalDate date, List<WorkType> workType);


    List<WorkLogs> findByDurationGreaterThanEqual(int durationMinutes);
    List<WorkLogs> findByDateRangeAndWorkType(LocalDate begin, LocalDate end, List<WorkType> workType);
}
